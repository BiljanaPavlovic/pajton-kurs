...
def unos_broja():
    unos=input("Unesite koliko mesta želite da dodate u spisak:")

    while unos.isdecimal()==False or int(unos)<2:
        unos=input("Uneli ste pogrešnu vrednost, pokušajte ponovo: ")
...
def udaljenost():
    ...
    print(f"Rastojanje između dva mesta je {rastojanje}km.")
###########################################
